const handlePdf = () => {
    ...
    console.log(`http://127.0.0.1:8000/doctor/list/${doctor_id}`);
            ...
            fetch(`http://127.0.0.1:8000/users/${user_id}`)
                ...
                .then((pdData) => {
                  ...
                  console.log(patient_id);
                    fetch(`http://127.0.0.1:8000/patient/list/${patient_id}`)
                    .then((res) => res.json())
                    .then((ptData) => {

                      const newData = [data, pdData,ptData];
                    console.log(newData, pdData, ptData);
                ...
                <img class="w-25" src=${newData[0].image}/>
                  ...
                  <h3>designation: ${newData[0].designation}</h3>
                  <h5>specialization: ${newData[0].specialization}</h5>
                </div>
              </div>
